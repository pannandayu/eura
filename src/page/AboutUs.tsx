    ...
    <div className={styles["about-us"]}>
      ...
      <div style={{ maxWidth: "50%", lineHeight: "150%" }}>
        ...
        >
          ...
          consistently maintained its position as a <b>robust and reliable </b>
        ...
        >
          ...
          authenticity. We offer <b>genuine products</b> with a modest markup to
        ...
        >
          ...
          business ethos, we believe in delivering <b>quality through action</b>{" "}
          rather than words.
        </motion.p>
      </div>
    </div>
